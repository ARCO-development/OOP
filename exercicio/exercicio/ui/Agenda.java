...
public class Agenda {
    ...
    private void inicializaCadastro() {
        cadastro.adicionaPessoa(new Pessoa("Darth Vader", 11111111));
        cadastro.adicionaPessoa(new Pessoa("Padme Amidala Naberrie", 22222222));
        cadastro.adicionaPessoa(new Pessoa("Luke Skywalker", 33333333));
        cadastro.adicionaPessoa(new Pessoa("Leia Organa", 44444444));
        cadastro.adicionaPessoa(new Pessoa("Han Solo", 55555555));
        cadastro.adicionaPessoa(new Pessoa("Obi-Wan Kenobi", 66666666));
        cadastro.adicionaPessoa(new Pessoa("Yoda", 77777777));
        cadastro.adicionaPessoa(new Pessoa("Rey", 88888888));
        cadastro.adicionaPessoa(new Pessoa("Sheeve Palpatine", 99999999));
